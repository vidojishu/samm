...
if (isset($_POST['demande_retrait'])) {
    ...
    if ($montant_retrait <= $gain_affiliation) {
        ...
        <p>Montant demandé: $montant_retrait.</p>
        <p>Numéro de téléphone de dépot: $telephone_user</p> 
        <p>Détails de paiement: $details_retrait</p> 
        </body>
        </html>
        ";
        ...
        @mail('contact@samm.Com', 'Demande de retrait Affiliation', $body, $headers, '-frebonds@samm.com'); 
          ...
          <div class="col-md-6">
            <form action="" method="post">
                <div class="form-group">
                    <div class="col-md-12">
                        <p style="color:blue">Effectuer votre demande !</p>
                        <label for="">Montant du retrait</label>
                        <input type="number" class="form-control" required name="montant_retrait" id="">
                        <label for="">Numéro de téléphone de dépot</label>
                        <input type="number" class="form-control" required name="telephone_user" id="">            
                        <label for="">Détails du retrait</label>
                        <textarea class="form-control" placeholder="Veuillez indiquez les informations nécessaires(numéro momo ou numéro de votre compte bancaire) en fonction de votre moyen de paiement." name="details_retrait" required></textarea>
                    </div>
                </div><br>
                <div class="form-group">
                    <div class="col-md-6">
                        <input type="submit" class="form-control btn btn-primary" value="Demande de retrait" name="demande_retrait">
                    </div>
                </div>
            </form>
        </div>
...
while($retrait = $req->fetch()){
    ...
    <tr>
        ...
        <td><?php echo $retrait['moyen_paiement'];?></td>
