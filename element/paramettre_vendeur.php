...
<h4> Parametre  </h4> <a href="#" title="Indisponible pour le moment" style="float: right;" > <button>Configurer ma boutique</button> </a> <p><br/></p> <p><br/></p> 
<table class="">
	<tr>
                                    <th>Nom et prénom</th>
                                    <th>Email</th>
	...
	<div class="row">
		<div class="col-md-6">
			<form action="" method="post">
				...
				<div class="form-group">
					<div class="col-md-6">
						<input type="submit" class="form-control btn btn-primary" value="Modifier informations" name="modif_infos">
					</div>
				</div>
			</form>
		</div>
